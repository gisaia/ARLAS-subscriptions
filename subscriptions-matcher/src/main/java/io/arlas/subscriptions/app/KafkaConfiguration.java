...
public class KafkaConfiguration {
    ...
    @JsonProperty("kafka-topic-subscription-events")
    public String subscriptionEventsTopic;

    @JsonProperty("kafka-topic-notification-orders")
    public String notificationOrdersTopic;
}
